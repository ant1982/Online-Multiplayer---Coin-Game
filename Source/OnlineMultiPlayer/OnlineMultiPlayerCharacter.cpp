...
//////////////////////////////////////////////////////////////////////////
// AOnlineMultiPlayerCharacter

AOnlineMultiPlayerCharacter::AOnlineMultiPlayerCharacter()
{
...
void AOnlineMultiPlayerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AOnlineMultiPlayerCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AOnlineMultiPlayerCharacter::MoveRight);

	// We have 2 versions of the rotation bindings to handle different kinds of devices differently
	// "turn" handles devices that provide an absolute delta, such as a mouse.
	// "turnrate" is for devices that we choose to treat as a rate of change, such as an analog joystick
	PlayerInputComponent->BindAxis("Turn", this, &APawn::AddControllerYawInput);
	PlayerInputComponent->BindAxis("TurnRate", this, &AOnlineMultiPlayerCharacter::TurnAtRate);
...
void AOnlineMultiPlayerCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AOnlineMultiPlayerCharacter::MoveForward(float Value)
{
...
void AOnlineMultiPlayerCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
